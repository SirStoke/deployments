                ...
                case 'start':
                    {
                        ...
                        yield client.repos.createDeploymentStatus(Object.assign({}, repo, { deployment_id: deployment.data.id, state: 'in_progress', log_url: logsURL || `https://github.com/${repo.owner}/${repo.repo}/commit/${commitSHA || sha}/checks`, description }));
